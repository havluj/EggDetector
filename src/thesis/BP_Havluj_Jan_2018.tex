...
\begin{conclusion}
	...
	Prvním øešením pro detekci vajec byla implementace realizována technikou \uv{detekce objektù v~obraze}. Tato implementace pøinesla velmi dobré výsledky a proto jsem se ji rozhodl použít jako základ pro výslednou knihovnu. Druhý styl implementace nebyl tak efektivní, a proto jsem se rozhodl ho nepoužít. Nicménì i tento styl implementace je zajímavý a mùže sloužit jako užiteèný základ pro ètenáøe, který se bude zabývat rozpoznáváním obrazu.
