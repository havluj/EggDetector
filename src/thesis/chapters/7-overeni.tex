...
Abych dokázal, že souèasná implementace knihovny funguje, napsal jsem dva \uv{jednotkové testy}\footnote{Unit testing.}. 
...
Je vidìt, že distribuce funguje. Zdrojové kódy externího projektu se nachází v pøíloze \ref{chap:cd} ve složce \texttt{src/impl/libtest}.
...
Zdrojový kód testu je vypsán v pøíloze \ref{chap:test_efektivity}. Knihovnu otestujeme pìtkrát na stejných datech s pìti rùznými nastaveními \uv{thresholdu}. V testech se zamìøíme na dvì metriky. První metrikou je pomìr je procentuální úspìšnost knihovny. Tu získáme následujícím zpùsobem:
\begin{equation*}
	\boxed{
	\begin{gathered}
