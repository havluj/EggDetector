...
\begin{itemize}
	\item Všechny složky a podsložky dostupné na serveru budou staženy lokálnì do složky \newline\texttt{\$DIRECTORY}.
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{media/tagger.png}
...
\lstinputlisting[language=XML,label={list:labelimg}]{media/labelimg.xml}
