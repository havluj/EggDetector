...
\acknowledgements{Chtìl bych podìkovat vedoucímu mé bakaláøské práce, panu Ing. Josefovi Pavlíèkovi Ph.D. za jeho èas, ochotu a pomoc pøi vedení této práce. Dìkuji svým rodièùm a pøítelkyni, kteøí mi byli po celou dobu studia velkou oporou. V~neposlední øadì bych chtìl podìkovat svým spolužákùm, s~kterými bylo celé studium pøíjemnìjší.}
...
\keywordsCS{neuronové sítì, poèítaèové vidìní, detekce objektù, rozpoznávání obrazu, detekce vajec, Java knihovna}
\keywordsEN{neural networks, computer vision, object detection, image recognition, egg detection, Java library}
