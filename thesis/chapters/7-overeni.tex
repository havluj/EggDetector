...
\section{Závìr}
V této kapitole jsme dokázali, že má implementace knihovny funguje a je možné jí použít formou závislostí z jiného projektu. Mìøením efektivity knihovny jsme došli k závìru, že nejlepší nastavení hranice pro detekci objektù je \textbf{30\%}. Knihovnu tedy upravíme tak, aby toto nastavení používala jako výchozí hodnotu.