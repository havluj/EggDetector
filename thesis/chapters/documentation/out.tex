...
P?íloha obsahuje dokumentaci API knihovny, která je výsledkem této práce. Dokumentace je vygenerována p?ímo ze
zdrojového kódu nástroji javadoc a TexDoclet
