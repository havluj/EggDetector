...
Pøíloha obsahuje dokumentaci API Java knihovny, která je výsledkem této práce. Dokumentace byla vygenerována ze zdrojových kódù nástroji javadoc\footnote{\url{http://www.oracle.com/technetwork/java/javase/documentation/index-jsp-135444.html}} a TexDoclet\footnote{\url{http://doclet.github.io/}}. Kód je psán v~anglickém jazyce, stejnì jako jeho dokumentace. Proto je text i zde v~angliètinì.
