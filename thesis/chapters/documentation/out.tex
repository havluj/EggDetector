...
Pøíloha obsahuje dokumentaci API Java knihovny, která je výsledkem této práce. Dokumentace byla vygenerována ze zdrojových kódù nástroji Javadoc\cite{javadoc} a TexDoclet\cite{texdoclet}. Kód je psán v~anglickém jazyce, stejnì jako jeho dokumentace. Proto je text i zde v~angliètinì.
