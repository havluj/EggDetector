\chapter{Folder Trimmer}
Tato pøíloha obsahuje zdrojový kód a zpùsob použití nástroje \texttt{FolderTrimmer}. Kompletní dokumentace a zdrojový kód je dostupný na pøiloženém CD (viz pøíloha \ref{chap:cd}).
