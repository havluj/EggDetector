...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item For example to delete only useless data but keep all the folders with	some image data, use: \texttt{target\textbackslash run.bat false C:\textbackslash school\textbackslash bakalarka\textbackslash data}.
		\item To delete everything except tagged data, run: \texttt{target\textbackslash run.bat true C:\textbackslash school\textbackslash bakalarka\textbackslash data}.
	\end{itemize}
\end{itemize}
